...
const cadastrarUsuario = async (req, res) => {
    ...
    try {
        ...
        const emailEnviado = {
            from: 'Market Cubos <no-reply@marketcubos.com>',
            to: email,
            subject: 'Bem-vindo ao Market Cubos!',
            text: `Olá, ${nome}! Você acabou de se cadastrar no Market Cubos e já pode se logar!`
        }

        nodemailer.sendMail(emailEnviado);
